...
export class BuyComponent implements OnInit {
  ...
  constructor(private http: Http, private matchService: MatchService, private router: Router, private authGuard: AuthGuard, private userService: UserService, public globals : GlobalsComponent) {
